    ...
    <AppLayout title="vehicle images">
        <template #header>
            <div class="flex justify-between">
                ...
                <button class="bg-green-100 hover:bg-green-200 w-12 rounded-md shadow-abajo-1" @click="form.get(route('vehicles.images.index', props.vehicleimages.id))">
                ...
                <div class="bg-3D-50 overflow-hidden shadow-abajo-2 rounded-lg">
                    ...
                    <div class="p-3">
                        ...
                        <div class="block sm:hidden rounded-lg">
                            <div v-for="vehicleimage in vehicleimages.vehicleimages" :key="vehicleimage.id"
                                ...
                                <div class="text-md text-slate-700 flex items-center justify-center">
                                    <p>
                                        <img :src="vehicleimage.image
                                                        ? vehicleimage.image
                                                        : asset(
